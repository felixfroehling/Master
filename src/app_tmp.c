...
static const char *CompileLibs[] = {
    /* /opt/ipg/carmaker/linux64-9.0/lib/libcar.a */
    /* /opt/ipg/carmaker/linux64-9.0/lib/libcarmaker.a */
    /* /opt/ipg/carmaker/linux64-9.0/lib/libipgdriver.a */
    /* /opt/ipg/carmaker/linux64-9.0/lib/libipgroad.a */
    /* /opt/ipg/carmaker/linux64-9.0/lib/libipgtire.a */
    "libcar.a	CarMaker-Car linux64 9.0 2020-05-15",
    "libcarmaker.a	CarMaker linux64 9.0 2020-05-15",
    "libipgdriver.a	IPGDriver linux64 9.0 2020-04-21",
    "libipgroad.a	IPGRoad linux64 9.0 2020-05-15",
...
static const char *CompileFlags[] = {
    "-O3 -DNDEBUG -DLINUX -DLINUX64 -D_GNU_SOURCE",
    "-D_FILE_OFFSET_BITS=64 -DCM_NUMVER=90000",
    "-I/opt/ipg/carmaker/linux64-9.0/include -m64 -fPIC",
...
tAppStartInfo   AppStartInfo = {
    ...
    "39",          /* App_BuildVersion    */
    "felix",     /* App_CompileUser     */
    "hilsim-poweredge-t630",         /* App_CompileSystem   */
    "2020-11-11 14:23:06",  /* App_CompileTime */
